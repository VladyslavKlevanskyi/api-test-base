...
from test_data.apartment_test_data import (
    APARTMENTS_DATA,
    get_apartment_data, FIELD_UPDATE_VALID_TEST_PARAMS,
...
async def test_update_apartment_body(
    ...
    sleep(13)
    await update_apartment_endpoint.update_apartment(
...
async def test_update_one_field_in_apartment_with_valid_data(
        create_apartment_endpoint: CreateApartment,
        update_apartment_endpoint: UpdateApartment,
        field: str,
        value: str | bool | int | float,
        expected_value: str | bool | int | float,
) -> None:
...
async def test_update_one_field_in_apartment_with_invalid_data(
        create_apartment_endpoint: CreateApartment,
        update_apartment_endpoint: UpdateApartment,
        payload: dict[str, Any],
...
@pytest.mark.negative
@pytest.mark.asyncio
async def test_update_apartment_with_duplicate_unit_id_fails(
...
async def test_update_apartment_with_invalid_headers(
        create_apartment_endpoint: CreateApartment,
        update_apartment_endpoint: UpdateApartment,
