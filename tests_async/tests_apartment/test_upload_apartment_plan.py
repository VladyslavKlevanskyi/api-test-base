...
async def test_upload_plan(
    ...
    await upload_plan_endpoint.upload_plan_image(
        file=prepared_file,
        unit_id=unit_id
    )
    ...
    await upload_plan_endpoint.check_file_availability_by_link(
...
async def test_upload_plan_with_invalid_file_format(
        create_apartment_endpoint: CreateApartment,
        upload_plan_endpoint: UploadApartmentPlan,
        apartment_data: dict[str, Any],
        file_format: str,
...
async def test_retrieve_apartment_by_id_with_invalid_headers(
        create_apartment_endpoint: CreateApartment,
        upload_plan_endpoint: UploadApartmentPlan,
