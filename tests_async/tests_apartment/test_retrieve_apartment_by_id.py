...
async def test_retrieve_apartment_by_id(
    ...
    await retrieve_apartment_endpoint.retrieve_apartment_by_id(apartment_id)
    # Assertions
...
@pytest.mark.negative
@pytest.mark.asyncio
async def test_retrieve_apartment_by_incorrect_id(
        retrieve_apartment_endpoint: RetrieveApartment
) -> None:
