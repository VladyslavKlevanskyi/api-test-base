...
@pytest.mark.asyncio
async def test_me_endpoint(me_endpoint: Me) -> None:
    await me_endpoint.open_me()
...
async def test_me_endpoint_with_invalid_data(
        me_endpoint: Me,
        headers: Dict,
        message: str
) -> None:
    await me_endpoint.open_me(headers=headers)
