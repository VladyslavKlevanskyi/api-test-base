...
async def test_delete_user(
    ...
    await delete_user_endpoint.delete_user_by_id(user_id=user_id)
    # Assertions
...
async def test_delete_user_with_invalid_headers(
        register_user_endpoint: CreateUser,
        delete_user_endpoint: DeleteUser,
    ...
    await delete_user_endpoint.delete_user_by_id(
        user_id=user_id,
        headers=headers
    )
    # Assertions
...
@pytest.mark.negative
@pytest.mark.asyncio
async def test_delete_user_without_admin_rights(
