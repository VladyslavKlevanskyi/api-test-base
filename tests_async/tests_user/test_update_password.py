...
async def test_update_user_password(
    ...
    await update_user_password_endpoint.update_user_password(
        user_id=user_id,
...
async def test_update_user_password_with_invalid_data(
        register_user_endpoint: CreateUser,
        update_user_password_endpoint: UpdateUserPass,
        login_endpoint: Login,
...
@pytest.mark.negative
@pytest.mark.asyncio
async def test_update_user_password_by_by_incorrect_id(
        update_user_password_endpoint: UpdateUserPass
) -> None:
...
async def test_update_user_password_with_invalid_headers(
        register_user_endpoint: CreateUser,
        update_user_password_endpoint: UpdateUserPass,
        login_endpoint: Login,
...
@pytest.mark.negative
@pytest.mark.asyncio
async def test_update_user_password_without_admin_rights(
        login_endpoint: Login,
        register_user_endpoint: CreateUser,
        update_user_password_endpoint: UpdateUserPass
) -> None:
