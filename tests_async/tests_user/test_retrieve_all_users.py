...
async def test_retrieve_all_users(
    ...
    await retrieve_users_endpoint.retrieve_all_users()
    # Assertions
...
async def test_retrieve_all_users_with_invalid_headers(
        create_few_users: list,
        retrieve_users_endpoint: RetrieveAllUsers,
        headers: dict[str, str],
        message: str,
) -> None:
    await retrieve_users_endpoint.retrieve_all_users(headers=headers)
...
@pytest.mark.negative
@pytest.mark.asyncio
async def test_retrieve_all_users_without_admin_rights(
        create_few_users: list,
        retrieve_users_endpoint: RetrieveAllUsers,
